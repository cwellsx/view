...
appendLine("/* Do not edit -- this source fle is created programmatically by /prebuild-data/src/readImages.ts */");
...
export function readImages(inputImages: string, outputImages: string, rootOutputDir: string): string[] {
  appendLine('import { Data } from "shared-lib";');
